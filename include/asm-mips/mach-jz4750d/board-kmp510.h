 ...
 *
 *  The KMP510 is an internet radio by SKY-TC. it is probably
 *  developed from the CETUS board.
 *
 *  Author: <anders.franzen@yahoo.se>
 *
...
#ifndef __ASM_JZ4750D_KMP510_H__
#define __ASM_JZ4750D_KMP510_H__
