...
// FIXUP#define SDBUS_DEFAULT_REQ_LIST_SIZE         16
...
// FIXUP#define MAX_CARD_DETECT_MSGS                16   
...
typedef struct _BDCONTEXT {
    ...
    INT              RequestListSize;        /* 76 default request list */
    INT              SignalSemListSize;      /* 80 default signalling semaphore size */
    INT              CurrentRequestAllocations; /* 84,84 current count of allocated requests */
...
// FIXUP    SD_BUSCLOCK_RATE DefaultOperClock;       /* default operation clock */
...
#define BD_CONFIG_SDREQ_FORCE_ALL_ASYNC 0x00000001
    INT              MaxHcdRecursion;        /* 188, 164 max HCD recurion level */
