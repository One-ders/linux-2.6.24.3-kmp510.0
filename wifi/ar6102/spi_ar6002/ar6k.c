...
#define ATH_DEBUG_DMP 0x8

A_STATUS DevEnableInterrupts(AR6K_DEVICE *pDev);
A_STATUS DevDisableInterrupts(AR6K_DEVICE *pDev);
#define __FILE__ "/app1/colman2/ar6k/AR6102-2.2.0.78/AR6kSDK.build_sw.78/host/os/linux/../../htc2/AR6000/ar6k.c"
#if 0
...
A_STATUS DevSetup(AR6K_DEVICE *pDev)
{
    ...
    do {
        ...
        AR_DEBUG_PRINTF(ATH_DEBUG_TRC,("HIF special overrides : 0x%X , 0x%X\n",
                 (unsigned int)pDev->GetPendingEventsFunc, (unsigned int)pDev->HifMaskUmaskRecvEvent));
...
void DevDumpRegisters(
//AR6K_DEVICE               *pDev,
                      AR6K_IRQ_PROC_REGISTERS   *pIrqProcRegs,
                      AR6K_IRQ_ENABLE_REGISTERS *pIrqEnableRegs)
{

    AR_DEBUG_PRINTF(ATH_DEBUG_DMP, ("\n<------- Register Table -------->\n"));
