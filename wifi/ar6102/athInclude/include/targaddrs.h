...
//#define AR6001_VTOP(vaddr) ((vaddr) & 0x001fffff)
...
#define TARG_VTOP(TargetType, vaddr) \
        ...
        (((TargetType) == TARGET_TYPE_AR6003) ? AR6003_VTOP(vaddr) : 0)))
//        (((TargetType) == TARGET_TYPE_MCKINLEY) ? MCKINLEY_VTOP(vaddr) : 0))))

#define TARG_VTOP1(TargetType, vaddr) \
	(((TargetType) == TARGET_TYPE_AR6001) ? AR6001_VTOP(vaddr) : AR6002_VTOP(vaddr))
